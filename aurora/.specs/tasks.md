...
- [x] 17.2 E2E workflow (`aurora-e2e.yml`): deploy via bootstrap, verify canaries, load test + ARC failover exercise, cleanup on success. 2h session, account 123456789012
